...
import gov.nih.nci.cgems.web.action.BrowseAction;
import gov.nih.nci.cgems.web.action.SearchStudyHelper;
...
/**
 * CgemsActionTest is a base class that handles the initial setup for
 ...
 *
 */
public class CgemsActionTest extends MockStrutsTestCase
{
	...
	public CgemsActionTest(String testName)
	{
		super(testName);
	}
	
	/**
	 * Uses the CGEMS DTO to retrieve the list of available studies. These are
	...
	/**
	 * Uses the CGEMS DTO to retrieve the list of available chromosomes. These are
	...
	/**
	 * Uses the CGEMS DTO to retrieve the list of available populations for a specific
