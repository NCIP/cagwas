 ...
 *
 * $Id: columnav.js,v 1.1 2007-02-22 15:55:45 landyr Exp $
 */
...
YAHOO.extension.ColumNav.prototype = {
    ...
    _createMenu: function(node) {
        ...
        for (var i = 0; i < items.length; i++) {
            ...
            //rl
            var omo = link.getAttribute('onmouseover');
            var omout = link.getAttribute('onmouseout');
            //end rl
            ...
            //rl
             a.setAttribute('onmouseover', omo);
             a.setAttribute('onmouseout', omout);
            //end rl
            a.list = list;
            if (cls)
